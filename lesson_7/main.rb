...
class RailRoad
  ...
  def menu
    options = {
      ...
      7 => "Перемещать поезд по маршруту вперед и назад", 8 => "Загрузка тестовых данных", 9 => "Просматривать список станций и список поездов на станции",
      0 => "Выход из меню"
    }
      ...
      @stations.each do |station|
        ...
        station.each_train do |train|
          ...
          train.each_wagon do |wagon|
            puts "Вагон: #{wagon.number}, тип: #{wagon.type}, занято: #{wagon.volume - wagon.occupied_volume}, свободно: #{wagon.occupied_volume}"
          end
        end
      end
    menu
